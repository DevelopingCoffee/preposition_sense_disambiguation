...
wandb_apikey = "YOUR_API_KEY" # your personal api-key from weights and bias
path_data = "preposition_sense_disambiguation/huggingface_sense_disambiguation/torch/data/training_data.tsv" # where your input-data is
label_prep_map_path = "preposition_sense_disambiguation/huggingface_sense_disambiguation/torch/label_prep_map.tsv" # location of label-prep-map (for error analysis)
